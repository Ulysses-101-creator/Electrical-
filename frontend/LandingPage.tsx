  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6">
        ...
        <button className="rounded-xl bg-brand-600 px-5 py-3 font-medium hover:bg-brand-500">
          Start free trial
        </button>
      </nav>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          <div>
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.25em] text-brand-400">
            ...
            <h1 className="text-5xl font-extrabold leading-tight lg:text-6xl">
              ...
              <span className="text-brand-400"> under 60 seconds.</span>
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              <button className="rounded-xl bg-brand-600 px-6 py-4 font-semibold hover:bg-brand-500">
                Start free trial
              </button>

              <button className="rounded-xl border border-slate-700 px-6 py-4 font-semibold text-slate-300 hover:border-brand-500 hover:text-white">
                Watch demo
              </button>
            </div>
          </div>
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-2xl">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-950 p-4">
 x               <p className="text-sm text-slate-400">Acceptance rate</p>
