...
<p className="mt-10 max-w-xl text-xl leading-9 text-slate-400">
  ...
  and manage every customer and job from one streamlined workspace.
      ...
      <div className="mt-12 flex gap-4">
        ...
        <a href="#sample" className="border border-white/10 px-6 py-3 rounded-lg text-slate-300">
          View sample quote
        </a>
      </div>
    </div>
...
<p className="text-sm text-gray-500">Issued to: Sandton Office Park</p>
      ...
      <div className="mt-8 space-y-4 text-sm">
        <div className="flex justify-between">
          <span>Main DB replacement</span>
          <span>R8,500</span>
        </div>
        <div className="flex justify-between">
          <span>Circuit testing</span>
          <span>R1,800</span>
        </div>
        <div className="flex justify-between">
          <span>Materials</span>
